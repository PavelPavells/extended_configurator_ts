...
interface OfferProps {
    readonly data: any,
    readonly fetchDataBarrier: (data: any) => void,
        ...
        return (
            ...
            <section className="offer">
                ...
                <div className="offer__goods goods">
                    ...
                    {barrier.data.page_view.model_module_list.map((index: any, key: any) => (
                            ...
                            <div className="blocks__main main">
                                <div className="main__left left">
                                    <div className="left__image image">
                                        <img className='image__photo' src={barrier.data.page_view.model_main_photo} alt="" />
                                ...
                                <div className="main__info info">
                                    <div className="info__value">{barrier.data.page_view.model_module_list.length}</div>
                                ...
                                {this.state.modal && key === 0 ?
                                    <div className="offer-info">
                                            ...
                                            <div className="offer-caption__list">
                                                {barrier.data.page_view.model_module_list.map((index: any, key: any) => (
                                                    <div key={index.name} className="offer-equipment">
                                                        ...
                                                        <span className="offer-equipment__amount">{barrier.data.page_view.model_module_list.length}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                        <div className="offer-caption">
                                            ...
                                            <div className="offer-caption__list">
                                                {barrier.data.page_view.model_module_list.slice(1).map((index: any, key: any) => (
                                                    <div key={index.name} className="offer-equipment">
                                                        <div className="offer-equipment__paragraph">{index.caption}</div>
                                                        <div className="offer-equipment__info">
                                                            <div className="offer-equipment__info-value">{barrier.data.page_view.model_module_list.length}</div>
                ...
                <div className="offer__price price">
                    <div className="price__wrapper wrapper">
                        ...
                        <div className="wrapper__full full">
                            ...
                            <div className="full__price">{barrier.data.page_view.model_price}</div>
                        </div>
                        <div className="wrapper__sale sale">
                            <div className="sale__text text">Скидка<span className="text__sale">25%</span></div>
                            <div className="sale__price">&mdash; {barrier.data.page_view.model_price}</div>
                        </div>
                    </div>
                    <div className="price__total total">
                        <div className="total__text">Итого со скидкой</div>
                        <div className="total__price">{barrier.data.page_view.model_price}</div>
                    </div>
                </div>
