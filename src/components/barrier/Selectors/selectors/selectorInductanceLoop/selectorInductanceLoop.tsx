 ...
 * Импорт прелоадера
 */
//import InductanceLoopPopUp from '../../../../popup/popup';
...
/**
 * Интерфейс компонента SelectorInductanceLoop
 */
...
class SelectorInductanceLoop extends React.PureComponent<SelectorInductanceLoopProps, SelectorInductanceLoopState> {
    ...
    state: SelectorInductanceLoopState = { selectSeven: 0 };
    ...
    /**
    * Хэндлер для обработки запроса селектора 'Модуль подключения петли индуктивности VLD-10-V'
    */
                        ...
                        return (
                            <div key={index.index} className="selectors__module module none">
                                <div className="module__left left">
                                    ...
                                    <div className="left__text">Модуль подключения петли индуктивности VLD-10-V</div>
                                </div>
