...
import logo from '../../../images/icon/emmarin.svg'
...
/**
 * Интерфейс компонента EMMarinPopup
 */
interface EMMarinPopupProps {
    readonly data: any,
...
class EMMarinPopup extends React.PureComponent<EMMarinPopupProps> {
    ...
    private handleCloseModal = () => {
        ...
        /**
         *  Функция тогглинга всплывающего окна из компонента selectorEMMarin
         */
    ...
    private handleAddOption = () => {
        this.props.handleClickTwoSelect();
